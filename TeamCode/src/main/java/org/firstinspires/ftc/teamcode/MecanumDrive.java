...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.001952884; // forward push test
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 406531.1686755742;

        // feedforward parameters (in tick units)
        public double kS = 1.1444426914463166;//1.1076399318287937; // forward push logger
        public double kV = 0.0002517335261020295; //0.00038250965746878694
        public double kA = 0.000001;// feedforward
        ...
        public double lateralGain = 0.075;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        //   leftFront.setDirection(DcMotorSimple.Direction.REVERSE);
        // Copied from test for functional car
