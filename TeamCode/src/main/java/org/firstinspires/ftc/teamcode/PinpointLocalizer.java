...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -153043.05802616884; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 24041.728015219964; // x position of the perpendicular encoder (in tick units)
    }
